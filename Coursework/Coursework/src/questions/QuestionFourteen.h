...
#pragma region Windows Form Designer generated code
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->radio_two->Text = L"Страничная";
			   ...
			   this->radio_one->Text = L"Сегментная";
			   ...
			   this->label1->Text = L"Со времён создания первых операционных систем инженеры разработали\r\nразличные мех"
				   L"анизмы организации работы с памятью В ОС Windows\r\nреализована _________ организа"
				   L"ция памяти";
