...
namespace Coursework {
	...
	/// <summary>
	/// Summary for QuestionEight1
	/// </summary>
	public ref class QuestionEight : public System::Windows::Forms::Form
	{
	public:
		QuestionEight(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(QuestionEight::typeid));
			...
			this->label1->Size = System::Drawing::Size(602, 100);
			...
			this->groupBox1->Location = System::Drawing::Point(106, 220);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(677, 209);
			...
			this->answer_3->Location = System::Drawing::Point(6, 100);
			this->answer_3->Name = L"answer_3";
			this->answer_3->Size = System::Drawing::Size(665, 79);
			this->answer_3->TabIndex = 2;
			this->answer_3->Text = L"Многозадачным режимом работы предполагает переключение между\r\nсуществующими проце"
				L"ссами, создавая ощущение (псевдо) параллельности\r\nработы всех запущенных програм"
				L"м\r\n";
			...
			this->answer_2->Location = System::Drawing::Point(6, 65);
			this->answer_2->Name = L"answer_2";
			this->answer_2->Size = System::Drawing::Size(504, 29);
			this->answer_2->TabIndex = 1;
			this->answer_2->Text = L"Все запущенные процессы выполняются одновременно";
			...
			this->answer_1->Size = System::Drawing::Size(570, 29);
			this->answer_1->TabIndex = 0;
			this->answer_1->Text = L"Концептуально, у каждого процесса есть свой виртуальный CPU";
			...
			this->button_next->Click += gcnew System::EventHandler(this, &QuestionEight::button_next_click);
			// 
			// QuestionEight
			// 
			...
			this->Name = L"QuestionEight";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Вопрос 8";
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &QuestionEight::button_exit_click);
...
#pragma endregion
	private:
		...
		{
			UserAnswers::Instance->setAnswerResult(8, Tools::handleAnswerEight(answer_1, answer_2, answer_3));

			Form^ next = gcnew QuestionNine();
			this->Hide();
			next->Show();
		}
	};
