...
namespace Coursework {
	...
	/// <summary>
	/// Summary for QuestionNine1
	/// </summary>
	public ref class QuestionNine : public System::Windows::Forms::Form
	{
	public:
		QuestionNine(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(QuestionNine::typeid));
			...
			this->label1->Size = System::Drawing::Size(637, 75);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Концепции процессов и потоков взаимосвязаны. Основываясь на знаниях,\r\nполученных "
				L"после прочтения теоретического материала,\r\nвыберите верные утверждения из списка"
				L" предложенных";
			...
			this->groupBox1->Location = System::Drawing::Point(295, 249);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(298, 125);
			...
			this->radio_two->Size = System::Drawing::Size(286, 29);
			this->radio_two->TabIndex = 4;
			this->radio_two->TabStop = true;
			this->radio_two->Text = L"Процессы порождают потоки";
			...
			this->radio_one->Size = System::Drawing::Size(286, 29);
			this->radio_one->TabIndex = 3;
			this->radio_one->TabStop = true;
			this->radio_one->Text = L"Потоки порождают процессы";
			...
			this->button_next->Click += gcnew System::EventHandler(this, &QuestionNine::button_next_click);
			// 
			// QuestionNine
			// 
			...
			this->Name = L"QuestionNine";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Вопрос 9";
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &QuestionNine::button_exit_click);
...
#pragma endregion
	private:
		...
		{
			UserAnswers::Instance->setAnswerResult(9, Tools::handleAnswerNine(radio_two));

			Form^ next = gcnew QuestionTen();
			this->Hide();
			next->Show();
		}
	};
