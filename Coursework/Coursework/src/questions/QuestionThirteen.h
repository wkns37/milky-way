...
namespace Coursework {
	...
	/// <summary>
	/// Summary for QuestionThirteen1
	/// </summary>
	public ref class QuestionThirteen : public System::Windows::Forms::Form
	{
	public:
		QuestionThirteen(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(QuestionThirteen::typeid));
			...
			this->groupBox2->Location = System::Drawing::Point(352, 249);
			this->groupBox2->Name = L"groupBox2";
			this->groupBox2->Size = System::Drawing::Size(184, 125);
			this->groupBox2->TabIndex = 0;
			this->groupBox2->TabStop = false;
			this->groupBox2->Text = L"Варианты ответов";
			// 
			// radio_two
			// 
			...
			this->radio_two->Size = System::Drawing::Size(141, 29);
			this->radio_two->TabIndex = 2;
			this->radio_two->TabStop = true;
			this->radio_two->Text = L"Абстрактной";
			...
			this->radio_one->Size = System::Drawing::Size(142, 29);
			this->radio_one->TabIndex = 1;
			this->radio_one->TabStop = true;
			this->radio_one->Text = L"Виртуальной";
			...
			this->button_next->Click += gcnew System::EventHandler(this, &QuestionThirteen::button_next_click);
			// 
			// label1
			// 
			...
			this->label1->Size = System::Drawing::Size(658, 75);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Прямая работа с оперативной памятью является наисложнейшим процессом.\r\nЧтобы абст"
				L"рагировать концепцию памяти и не усложнять разработку кода,\r\nсуществует идея ___"
				L"_______ памяти";
			...
			this->Name = L"QuestionThirteen";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Вопрос 13";
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &QuestionThirteen::button_exit_click);
...
#pragma endregion
	...
	private:
		...
		{
			UserAnswers::Instance->setAnswerResult(13, Tools::handleAnswerThirteen(radio_one));

			Form^ next = gcnew QuestionFourteen();
			this->Hide();
			next->Show();
		}
	};
