...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->header_title->Text = L"Лабораторная работа №1\r\n«Запись арифметических выражений\r\nна языке программирован"
			...
			this->button_home->Click += gcnew System::EventHandler(this, &Lab1::button_home_click);
			// 
			// field_y
			// 
			...
			this->button_calc->Click += gcnew System::EventHandler(this, &Lab1::button_calc_click);
			// 
			// groupBox1
			// 
			...
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &Lab1::button_exit_click);
...
#pragma endregion
	...
	private:
		...
		System::Void button_calc_click(System::Object^ sender, System::EventArgs^ e)
		{
			...
			double x = System::Convert::ToDouble(field_x->Text);
			double y = System::Convert::ToDouble(field_y->Text);
			...
			field_result->Text = result1.ToString();
		}
};
}
