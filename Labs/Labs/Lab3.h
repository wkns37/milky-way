...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->header_title->Size = System::Drawing::Size(1154, 71);
			this->header_title->TabIndex = 1;
			this->header_title->Text = L"Лабораторная работа №3\r\n«Обмен DLL библиотекой»";
			...
			this->button_home->Click += gcnew System::EventHandler(this, &Lab3::button_home_click);
			// 
			// field_y
			// 
			...
			this->button_calc->Click += gcnew System::EventHandler(this, &Lab3::button_calc_click);
			// 
			// groupBox1
			// 
			...
			this->groupBox1->Location = System::Drawing::Point(12, 83);
			...
			this->pictureBox1->Location = System::Drawing::Point(12, 320);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(287, 90);
			...
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &Lab3::button_exit_click);
...
#pragma endregion
	...
	private:
		...
		{
			/*
				TextBox^ field_x		— поле для параметра x
				TextBox^ field_y		— поле для параметра y
				TextBox^ field_result	— поле для ввывода результата
			*/
			/*double result1 = 0, result2 = 0;
			double x = Class1::vvod(field_x);
			double y = Class1::vvod(field_y);

			result1 = Class1::func(x, y);		// Получение результата первым способом
			Class1::proc(x, y, result2);		// Получение результата вторым способом
			assert(result1 == result2);			// Проверяем эквивалентность

			Class1::output(result1, field_result);*/
		}
	};
}
