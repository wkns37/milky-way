...
namespace Labs {
	...
	/// Summary for Lab17
	/// </summary>
	public ref class Lab17 : public System::Windows::Forms::Form
	{
	private:
		Form^ parent = nullptr;
	public:
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button_home->Location = System::Drawing::Point(1202, 1084);
			...
			this->button_home->Click += gcnew System::EventHandler(this, &Lab17::button_home_click);
			// 
			// label_copyright
			// 
			...
			this->label_copyright->Font = (gcnew System::Drawing::Font(L"Times New Roman", 14, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label_copyright->Location = System::Drawing::Point(12, 1000);
			...
			this->button_run->Click += gcnew System::EventHandler(this, &Lab17::button_run_click);
			// 
			// grid_second
			// 
			...
			this->button_do_insertation_sort->Click += gcnew System::EventHandler(this, &Lab17::button_do_insertation_sort_click);
			// 
			// groupBox6
			// 
			...
			this->groupBox6->Size = System::Drawing::Size(387, 461);
			...
			// button3
			// 
			this->button3->Font = (gcnew System::Drawing::Font(L"Segoe UI", 8, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button3->Location = System::Drawing::Point(6, 282);
			this->button3->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(375, 44);
			this->button3->TabIndex = 21;
			this->button3->Text = L"ШЕЙКЕР-СОРТИРОВКА";
			this->button3->UseVisualStyleBackColor = true;
			this->button3->Click += gcnew System::EventHandler(this, &Lab17::button_do_shaker_sort_click);
			// 
			// button2
			// 
			this->button2->Font = (gcnew System::Drawing::Font(L"Segoe UI", 8, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button2->Location = System::Drawing::Point(6, 231);
			this->button2->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(375, 44);
			this->button2->TabIndex = 20;
			this->button2->Text = L"СОРТИРОВКА ПРОСТЫМ ОБМЕНОМ (УЛУЧШЕННАЯ)";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &Lab17::button_do_bubble_sort_ext_click);
			// 
			// button1
			// 
			this->button1->Font = (gcnew System::Drawing::Font(L"Segoe UI", 8, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button1->Location = System::Drawing::Point(6, 179);
			this->button1->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(375, 44);
			this->button1->TabIndex = 19;
			this->button1->Text = L"СОРТИРОВКА ПРОСТЫМ ОБМЕНОМ";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &Lab17::button_do_bubble_sort_click);
			// 
			// button_load_array
			// 
			this->button_load_array->Font = (gcnew System::Drawing::Font(L"Segoe UI", 8, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button_load_array->Location = System::Drawing::Point(6, 386);
			...
			this->button_load_array->Click += gcnew System::EventHandler(this, &Lab17::button_load_array_click);
			// 
			// button_save_array
			// 
			this->button_save_array->Font = (gcnew System::Drawing::Font(L"Segoe UI", 8, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button_save_array->Location = System::Drawing::Point(6, 334);
			...
			this->button_save_array->Click += gcnew System::EventHandler(this, &Lab17::button_save_array_click);
			// 
			...
			this->button_do_selection_sort->Click += gcnew System::EventHandler(this, &Lab17::button_do_selection_sort_click);
			// 
			...
			this->button_do_binary_sort->Click += gcnew System::EventHandler(this, &Lab17::button_do_binary_sort_click);
			// 
			// label1
			// 
			...
			this->ClientSize = System::Drawing::Size(1381, 1141);
			...
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &Lab17::button_exit_click);
...
#pragma endregion
	...
	private:
		...
		System::Void button_do_bubble_sort_click(System::Object^ sender, System::EventArgs^ e)
		{
			DataGridView^ view = get_selected_grid();
			size_t size = 0;
			int* array = UtilsLibrary3::Utils::create_array_form_dgv(get_selected_grid(), size);
			UtilsLibrary3::Utils::bubble_sort(array, size);
			UtilsLibrary3::Utils::fill_with_array(view, array, size);
			delete[] array;
		}

		// Сортировка простым обменом (пузырьком), улучшенная
		System::Void button_do_bubble_sort_ext_click(System::Object^ sender, System::EventArgs^ e)
		{
			DataGridView^ view = get_selected_grid();
			size_t size = 0;
			int* array = UtilsLibrary3::Utils::create_array_form_dgv(get_selected_grid(), size);
			UtilsLibrary3::Utils::bubble_sort_ext(array, size);
			UtilsLibrary3::Utils::fill_with_array(view, array, size);
			delete[] array;
		}

		// Шейкер-сортировка
		System::Void button_do_shaker_sort_click(System::Object^ sender, System::EventArgs^ e)
		{
			DataGridView^ view = get_selected_grid();
			size_t size = 0;
			int* array = UtilsLibrary3::Utils::create_array_form_dgv(get_selected_grid(), size);
			UtilsLibrary3::Utils::shaker_sort(array, size);
			UtilsLibrary3::Utils::fill_with_array(view, array, size);
			delete[] array;
		}
