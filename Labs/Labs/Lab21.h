...
namespace Labs {
	...
	/// Summary for Lab21
	/// </summary>
	public ref class Lab21 : public System::Windows::Forms::Form
	{
	private:
		Form^ parent = nullptr;
	public:
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->header_title->Text = L"Лабораторная работа №12\r\n«Формирование и обработка двумерных массивов»";
			...
			this->button_home->Click += gcnew System::EventHandler(this, &Lab21::button_home_click);
			// 
			// label_copyright
			// 
			...
			this->button_run->Click += gcnew System::EventHandler(this, &Lab21::button_run_click);
			// 
			// groupBox1
			// 
			...
			this->groupBox2->Location = System::Drawing::Point(364, 197);
			this->groupBox2->Name = L"groupBox2";
			this->groupBox2->Size = System::Drawing::Size(331, 312);
			this->groupBox2->TabIndex = 5;
			this->groupBox2->TabStop = false;
			this->groupBox2->Text = L"Конечная матрица";
			// 
			// grid_second
			// 
			...
			this->grid_second->Size = System::Drawing::Size(319, 252);
			this->grid_second->TabIndex = 4;
			// 
			// Lab21
			// 
			...
			this->Text = L"Лабораторная №12";
			this->WindowState = System::Windows::Forms::FormWindowState::Maximized;
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &Lab21::button_exit_click);
...
#pragma endregion
	...
	private:
		...
		System::Void button_run_click(System::Object^ sender, System::EventArgs^ e)
		{
			...
			UtilsLibrary4::Utils::find_min_matrix(array, rows, columns, min_row, min_column);
			UtilsLibrary4::Utils::find_max_matrix(array, rows, columns, max_row, max_column);

			if (min_row != max_row)
			{
				UtilsLibrary4::Utils::swap_matrix_rows(array, rows, columns, min_row, max_row);
				MessageBox::Show(
					"Максимальный ([" + max_row + "][" + max_column + "]) и "
					"минимальный ([" + min_row + "][" + min_column + ") элементы "
					"находятся на разных строках. Меняем их местами.",
					"Вывод", MessageBoxButtons::OK, MessageBoxIcon::Information);
			}
			else
			{
				UtilsLibrary4::Utils::swap_matrix_columns(array, rows, columns, min_column, max_column);
				MessageBox::Show(
					"Максимальный ([" + max_row + "][" + max_column + "]) и "
					"минимальный ([" + min_row + "][" + min_column + "]) элементы "
					"находятся на одниковых строках. Меняем местами их столбцы.",
					"Вывод", MessageBoxButtons::OK, MessageBoxIcon::Information);
			}

			UtilsLibrary4::Utils::fill_with_matrix(grid_second, array, rows, columns);
