...
namespace Labs {
	...
	/// Summary for Lab9
	/// </summary>
	public ref class Lab9 : public System::Windows::Forms::Form
	{
	private:
		Form^ parent = nullptr;
	public:
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button_home->Click += gcnew System::EventHandler(this, &Lab9::button_home_click);
			// 
			// label_copyright
			// 
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label8->Location = System::Drawing::Point(12, 119);
			this->label8->Name = L"label8";
			this->label8->Size = System::Drawing::Size(1317, 104);
			this->label8->TabIndex = 2;
			this->label8->Text = L"При нажатии на кнопку «ЗАПОЛНИТЬ» будут сформированы массивы и записаны в базу да"
				L"нных, а в блоке вывода данных будет указано количество пар значений выведенного "
				L"массива, разность которых кратна 7.\r\n";
			...
			this->button_fill->Font = (gcnew System::Drawing::Font(L"Segoe UI", 8, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button_fill->Location = System::Drawing::Point(12, 227);
			...
			this->button_fill->Click += gcnew System::EventHandler(this, &Lab9::button_fill_click);
			// 
			// grid_second
			// 
			...
			this->groupBox2->Location = System::Drawing::Point(12, 448);
			...
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &Lab9::button_exit_click);
...
#pragma endregion
	...
	private:
		...
		System::Void button_fill_click(System::Object^ sender, System::EventArgs^ e)
		{
			...
			UtilsLibrary2::Utils::write_to_word("Исходный массив", arr1, number);
			UtilsLibrary2::Utils::write_to_word("Конечный массив", arr2, new_length);
			UtilsLibrary2::Utils::write_to_notepad(grid_first, grid_second);
